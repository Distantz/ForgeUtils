...
ForgeUtilsDatabaseManager.Init = function()
...
ForgeUtilsDatabaseManager.Setup = function()
...
ForgeUtilsDatabaseManager.ShutdownForReInit = function()
...
ForgeUtilsDatabaseManager.Shutdown = function()
